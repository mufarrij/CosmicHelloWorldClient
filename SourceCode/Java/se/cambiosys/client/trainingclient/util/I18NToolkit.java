...
import java.util.*;
import se.cambiosys.client.framework.components.*;
import se.cambiosys.client.framework.*;
...
public abstract class I18NToolkit
{
  ...
  private static CambioResourceBundle CONTACTOVERVIEW_COMMON_BUNDLE = CambioResourceBundle.getResourceBundle(CONTACTOVERVIEW_COMMON_BUNDLE_PATH);
